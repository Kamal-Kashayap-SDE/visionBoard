...
export const EditorData = () => (
  <div>
    <h3>
      ...
      <p>My name is Kamal Kashyap and currently i am pursuing my bachelor degree in engineering from Vellore Institute of Technology, BHOPAL. I am a passionate front-end developer who uses latest technologies to create user-interactive projects.</p>
      <p>In this project i have used ReactJs library and framework with syncfusion UI component to make it even more better than any other dashboard.</p>
      <p>This is a really a dashing looking dashboard in every aspect!</p>
      <p>It has 3 different pages for orders, employees and customers. It also supports 4 apps that are Calendar, a kanban board, a text-editor (currently you are seeing it/or may be using it ) and a color-picker also. This is a one-stop-solution for a dashboard that is good-looking, easy to use, user-interactive, and contains many apps within it to make your life easier.</p>
      <p>I hope you will like using it!</p>
      <p>Thank You! </p>
    </h3>
  </div>
);
...
export const chatData = [
  {
    image:
      avatar2,
    message: 'Fresher Joined the Team!',
  ...
  },
  {
    ...
    desc: 'Junior sent you new message',
    time: '11:56 AM',
  },
  {
    image:
